...
int menu()
{
    ...
    menuTexture1.loadFromFile("src/img/start.png");
    menuTexture2.loadFromFile("src/img/connect.png");
    menuTexture3.loadFromFile("src/img/exit.png");
    sf::Sprite menu1(menuTexture1), menu2(menuTexture2), menu3(menuTexture3);

    sf::Font font;
    font.loadFromFile("src/Abbieshire.ttf");
